...
// Check connection
			...
			if(isset($_GET['status'])){
				...
				if($status=='added'){
					...
					echo "<script>window.alert('Adding Error!')</script>";
                }
            }
    ...
    // output data of each row
               echo "<table style='width:100%;text-align: center;border:1px solid black'>";
                     ...
                     //echo "<a href='cart.php?varp=echo $row["product_name"] '>Add to cart</a>"; 
                     ?>
        <a href='addincart.php?varp=<?php echo $row["product_id"]?>'>Add to cart</a> 
        <?php
        echo "</td>";
