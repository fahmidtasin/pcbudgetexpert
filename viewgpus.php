...
<body id="body">
    ...
    <h2 style="text-align: center">Graphics Cards:</h2>
    <hr>
...
// Check connection
               ...
               die("Connection failed: " . $conn->connect_error);
                ...
                $sql = "SELECT product_name ,product_type,product_price,product_validity FROM products where product_type Like ('%graphic%')";
