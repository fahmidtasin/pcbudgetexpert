...
$sql = "SELECT product_name, product_type, product_price FROM products where '$option1'=product_price || '$option2'=product_price || '$option3'=product_price || '$option4'=product_price || '$option5'=product_price";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
   echo "<table style='width:100%;border-collapse:collapse;text-align: center;border:1px solid black'>";
                     echo "<thead>";
